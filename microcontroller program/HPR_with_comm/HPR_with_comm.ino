...
/*
  //int dataString_len = dataString.length() + 1;
  //const char *msg = "Absolute Pressure: " + P + " mb, " + "Altitude: " + a + " meters";
  //const char *msg = String(dataString,HEX);
  //char char_array[dataString_len];
  //const char *msg = dataString.toCharArray(char_array, dataString_len);
